require_relative './lib/linked_list_comp/version'

Gem::Specification.new do |spec|

  # Required attributes.
  spec.name                  = "linked_list_comp"
  spec.version               = LinkedListComposition::VERSION
  spec.authors               = ["Diligent Software LLC"]
  spec.email                 = ["contact@diligentsoftware.org"]
  spec.summary               = %q{A LinkedList composition. Composites the
Interface and Implementation.}
  spec.description           = %q{A LinkedList composition. Composites the
...
available at $1, $2, $4, $8, and $16. Greatly appreciated.}
  spec.homepage              =
      "https://docs.diligentsoftware.org/linkedlist#composition"
  ...
  spec.metadata['source_code_uri'] =
      "https://github.com/Diligent-Software-LLC/linked_list_comp"
